  ...
  <div class="page">
    <section class="hero">
      ...
      <div class="title-chip">
        <img class="chip-icon" src="@/assets/how-to-use/eat.png" alt="" />
        <span class="chip-text">กินได้ก่อ</span>
      </div>
    </section>
    ...
    <div class="nav-wrap">
      <div class="nav flex rounded-full overflow-hidden">
        <div
          ...
          @click="setActiveSection('EatCheckDoc')"
        >
        ...
        <div
          ...
          @click="setActiveSection('EatCheckVDO')"
        >
    ...
    <!-- เนื้อหา -->
    <div class="content">
      <EatCheckDoc v-if="isDoc" @updateGrade="emitGradeUpdate" />
      <EatCheckVDO v-else-if="isVDO" @updateGrade="emitGradeUpdate" />
    </div>
  </div>
</template>
...
import EatCheckDoc from './section-components/EatCheckDoc.vue'
import EatCheckVDO from './section-components/EatCheckVDO.vue'
import { PhNotepad, PhYoutubeLogo, PhArrowLeft } from '@phosphor-icons/vue'

type SectionKey = 'EatCheckDoc' | 'EatCheckVDO'

export default defineComponent({
  name: 'EatCheck',
  components: { EatCheckDoc, EatCheckVDO, PhNotepad, PhYoutubeLogo, PhArrowLeft },
  emits: ['back', 'updateGrade'],
  data() {
    return {
      activeSection: 'EatCheckDoc' as SectionKey,
  ...
  computed: {
    isDoc(): boolean {
      return this.activeSection === 'EatCheckDoc'
    },
    isVDO(): boolean {
      return this.activeSection === 'EatCheckVDO'
    },
  },
  methods: {
