  ...
  <div class="page">
    <section class="hero">
      ...
      <div class="title-chip">
        <img class="chip-icon" src="@/assets/how-to-use/achievement.png" alt="" />
        <span class="chip-text">แต้มสะสม</span>
      </div>
    </section>
    ...
    <div class="nav-wrap">
      <div class="nav flex rounded-full overflow-hidden">
        <div
          ...
          @click="setActiveSection('AchieveDoc')"
        >
        ...
        <div
          ...
          @click="setActiveSection('AchieveVDO')"
        >
    ...
    <!-- เนื้อหา -->
    <div class="content">
      <AchieveDoc v-if="isDoc" @updateGrade="emitGradeUpdate" />
      <AchieveVDO v-else-if="isVDO" @updateGrade="emitGradeUpdate" />
    </div>
  </div>
</template>
...
import AchieveDoc from './section-components/AchieveDoc.vue'
import AchieveVDO from './section-components/AchieveVDO.vue'
import { PhNotepad, PhYoutubeLogo, PhArrowLeft } from '@phosphor-icons/vue'

type SectionKey = 'AchieveDoc' | 'AchieveVDO'

export default defineComponent({
  name: 'RecordFood',
  components: { AchieveDoc, AchieveVDO, PhNotepad, PhYoutubeLogo, PhArrowLeft },
  emits: ['back', 'updateGrade'],
  data() {
    return {
      activeSection: 'AchieveDoc' as SectionKey,
  ...
  computed: {
    isDoc(): boolean {
      return this.activeSection === 'AchieveDoc'
    },
    isVDO(): boolean {
      return this.activeSection === 'AchieveVDO'
    },
  },
  methods: {
