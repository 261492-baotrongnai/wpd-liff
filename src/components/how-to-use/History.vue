  ...
  <div class="page">
    <section class="hero">
      ...
      <div class="title-chip">
        <img class="chip-icon" src="@/assets/how-to-use/diary.png" alt="" />
        <span class="chip-text">ดูบันทึกย้อนหลัง</span>
      </div>
    </section>
    ...
    <div class="nav-wrap">
      <div class="nav flex rounded-full overflow-hidden">
        <div
          ...
          @click="setActiveSection('HistoryDoc')"
        >
        ...
        <div
          ...
          @click="setActiveSection('HistoryVDO')"
        >
    ...
    <!-- เนื้อหา -->
    <div class="content">
      <HistoryDoc v-if="isDoc" @updateGrade="emitGradeUpdate" />
      <HistoryVDO v-else-if="isVDO" @updateGrade="emitGradeUpdate" />
    </div>
  </div>
</template>
...
import HistoryDoc from './section-components/HistoryDoc.vue'
import HistoryVDO from './section-components/HistoryVDO.vue'
type SectionKey = 'HistoryDoc' | 'HistoryVDO'

export default defineComponent({
  name: 'HistoryHowToUse',
  components: { HistoryDoc, HistoryVDO, PhNotepad, PhYoutubeLogo, PhArrowLeft },
  emits: ['back', 'updateGrade'],
  data() {
    return {
      activeSection: 'HistoryDoc' as SectionKey,
  ...
  computed: {
    isDoc(): boolean {
      return this.activeSection === 'HistoryDoc'
    },
    isVDO(): boolean {
      return this.activeSection === 'HistoryVDO'
    },
  },
  methods: {
